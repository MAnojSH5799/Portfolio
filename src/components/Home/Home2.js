...
import myImg from "../../Assets/manoj2.jpeg";
        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body" data-aos="fade-up">
              ...
              <i className="primary-header"> React.js.</i> and I have been involved in various projects and have gained experience in
technologies like React JS, Node JS, MySQL, and OpenAI and Firebase, Vercel, Render.com, Supabase Database
              <br />
              <br />
